...
int Sound::addDSP( std::string fileName, std::string dspName ){
	...
	{
		result = FMOD_Channel_AddDSP(soundInstanceVector->at(vectorSoundPos)->channel, dspInstanceVector->at(vectorDSPPos)->fmodDSP);
		ERRCHECK(result);
...
int Sound::addDSP( const int soundFileID, std::string dspName ){
	...
	{
		result = FMOD_Channel_AddDSP(soundInstanceVector->at(soundFileID)->channel, dspInstanceVector->at(vectorDSPPos)->fmodDSP);
		ERRCHECK(result);
...
void Sound::addDSP(std::string fileName , const int dspID ){
	...
	{
		result = FMOD_Channel_AddDSP(soundInstanceVector->at(vectorSoundPos)->channel, dspInstanceVector->at(dspID)->fmodDSP);
		ERRCHECK(result);
...
void Sound::addDSP( const int soundFileID, const int dspID ){
	...
	{
		result = FMOD_Channel_AddDSP(soundInstanceVector->at(soundFileID)->channel, dspInstanceVector->at(dspID)->fmodDSP);
		ERRCHECK(result);
